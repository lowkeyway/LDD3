...
#define SCULL_SYS_DEVICE "scull_sys_device"
#define SCULL_MISC_DEVICE "scull_misc_device"
#define SCULL_PLATFORM_DEVICE "scull_plt_device"
...
typedef struct scull_device{
	...
	struct platform_device *scull_pltdev;
}Scull_Device;
